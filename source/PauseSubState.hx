...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		levelInfo.setFormat(Paths.font("fullphanmuff.ttf"), 32);
		...
		levelDifficulty.setFormat(Paths.font('fullphanmuff.ttf'), 32);
		...
		blueballedTxt.setFormat(Paths.font('fullphanmuff.ttf'), 32);
		blueballedTxt.updateHitbox();
		add(blueballedTxt);

		practiceText = new FlxText(20, 15 + 101, 0, "PRACTICE", 32);
		practiceText.scrollFactor.set();
		practiceText.setFormat(Paths.font('fullphanmuff.ttff'), 32);
		...
		chartingText.setFormat(Paths.font('fullphanmuff.ttf'), 32);
